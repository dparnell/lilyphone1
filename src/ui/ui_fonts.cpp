...
void ui_fonts_init(void)
{
    ...
    font_with_symbols(&ui_font_mono_14, &Font_Mono_Bold_14, &lv_font_montserrat_14);
    font_with_symbols(&ui_font_mono_15, &Font_Mono_Bold_15, &lv_font_montserrat_14);
    font_with_symbols(&ui_font_mono_16, &Font_Mono_Bold_16, &lv_font_montserrat_14);
    font_with_symbols(&ui_font_mono_17, &Font_Mono_Bold_17, &lv_font_montserrat_18);
    font_with_symbols(&ui_font_mono_18, &Font_Mono_Bold_18, &lv_font_montserrat_18);
    font_with_symbols(&ui_font_mono_19, &Font_Mono_Bold_19, &lv_font_montserrat_18);
    font_with_symbols(&ui_font_mono_20, &Font_Mono_Bold_20, &lv_font_montserrat_18);
}
